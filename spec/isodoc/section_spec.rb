...
RSpec.describe IsoDoc do
        ...
        <br clear="all" style="mso-special-character:line-break;page-break-before:always"/>
           ...
           <h2>0.1<span style="mso-tab-count:1">&#160; </span>Introduction Subsection</h2>
            ...
            <div id="D">
             ...
             <div id="P" class="Section3">
                <h1 class="Annex"><b>Annex A</b><br/><span class="obligation">(normative)</span><br/><br/><b>Annex</b></h1>
         <p style="display:none;" class="variant-title-toc">Annex A<br/><span class="obligation">(normative)</span><span style="mso-tab-count:1">  </span>Annex</p>
                <div id="Q">
  ...
  it "processes inline section headers" do
    ...
    OUTPUT
    expect(IsoDoc::Iec::HtmlConvert.new({}).convert("test", input, true))
  ...
  it "adds colophon to published standard (Word)" do
    ...
    OUTPUT
    expect(IsoDoc::Iec::WordConvert.new({}).convert("test", input, true)
      .sub(/^.*<body /m, "<body ").sub(%r{</body>.*$}m, "</body>"))
  ...
  it "does not add colophon to draft standard (Word)" do
    ...
    OUTPUT
    expect(IsoDoc::Iec::WordConvert.new({})
      .convert("test", input, true)
      .sub(/^.*<body /m, "<body ")
      .sub(%r{</body>.*$}m, "</body>"))
      .to be_html4_equivalent_to output
