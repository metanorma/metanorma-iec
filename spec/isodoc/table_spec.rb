...
RSpec.describe IsoDoc do
  it "processes IsoXML tables" do
    ...
    html = <<~OUTPUT
           #{HTML_HDR}
             <div id="fwd">
               ...
               <table id="tableD-1" class="MsoISOTable" style="border-width:1px;border-spacing:0;width:70%;page-break-after: avoid;page-break-inside: avoid;table-layout:fixed;" title="tool tip">
                 <caption>Table 1&#xA0;&#x2014; Repeatability and reproducibility of <i>husked</i> rice yield<a class="FootnoteRef" href="#_"><sup>1)</sup></a><span style="display:none">long desc</span></caption>
                 <colgroup>
                   <col style="width: 30%;" />
                   <col style="width: 20%;" />
                   <col style="width: 20%;" />
           ...
           <a href="#ISO712">ISO&#xA0;712,  Section 2</a>
             ...
             <div id="Annex1" class="Section3">
               <p style="display:none;" class="variant-title-toc">Annex A<br /><span class="obligation">(informative)</span></p>
               <h1 class="Annex"><b>Annex A</b><br /><span class="obligation">(informative)</span></h1>
       ...
       <html xmlns:epub="http://www.idpf.org/2007/ops" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word" xmlns:m="http://schemas.microsoft.com/office/2004/12/omml" lang="en">
         <body lang="EN-US" link="blue" vlink="#954F72">
           <div class="WordSection2">
             ...
             <div id="fwd">
               <h1 class="ForewordTitle">FOREWORD</h1>
               <p class="TableTitle" style="text-align:center;">Table 1&#xA0;&#x2014; Repeatability and reproducibility of <i>husked</i> rice yield<span style="mso-bookmark:_Ref" class="MsoFootnoteReference"><a class="FootnoteRef" epub:type="footnote" href="#_">1</a>)</span></p>
                 ...
                 <table id="tableD-1" class="MsoISOTable" style="mso-table-anchor-horizontal:column;mso-table-overlap:never;border-spacing:0;border-width:1px;page-break-after: avoid;page-break-inside: avoid;" title="tool tip" summary="long desc" width="70%">
                   ...
                   <thead>
                     ...
                     <tr>
                       ...
                       <td valign="middle" align="center" style="border-top:none;mso-border-top-alt:none;border-bottom:solid windowtext 1.5pt;mso-border-bottom-alt:solid windowtext 1.5pt;page-break-after:avoid;" class="TABLE-col-heading">Drago<a href="#tableD-1a" class="TableFootnoteRef">a</a></td>
                       <td valign="bottom" align="center" style="border-top:none;mso-border-top-alt:none;border-bottom:solid windowtext 1.5pt;mso-border-bottom-alt:solid windowtext 1.5pt;page-break-after:avoid;" class="TABLE-col-heading">Balilla<a href="#tableD-1a" class="TableFootnoteRef">a</a></td>
                   ...
                   <tfoot>
                     <tr>
                       <td align="left" style="border-top:solid windowtext 1.5pt;mso-border-top-alt:solid windowtext 1.5pt;border-bottom:0pt;mso-border-bottom-alt:0pt;page-break-after:auto;" class="TABLE-cell">Reproducibility limit, <span class="stem">(#(R)#)</span> (= 2,83 <span class="stem">(#(s_R)#)</span>)</td>
                       <td align="center" style="border-top:solid windowtext 1.5pt;mso-border-top-alt:solid windowtext 1.5pt;border-bottom:0pt;mso-border-bottom-alt:0pt;page-break-after:auto;" class="TABLE-cell">2,89</td>
                       <td align="center" style="border-top:solid windowtext 1.5pt;mso-border-top-alt:solid windowtext 1.5pt;border-bottom:0pt;mso-border-bottom-alt:0pt;page-break-after:auto;" class="TABLE-cell">0,57</td>
                       <td align="center" style="border-top:solid windowtext 1.5pt;mso-border-top-alt:solid windowtext 1.5pt;border-bottom:0pt;mso-border-bottom-alt:0pt;page-break-after:auto;" class="TABLE-cell">2,26</td>
                       <td align="center" style="border-top:solid windowtext 1.5pt;mso-border-top-alt:solid windowtext 1.5pt;border-bottom:0pt;mso-border-bottom-alt:0pt;page-break-after:auto;" class="TABLE-cell">
                         <div class="figdl">
    ...
    expect(strip_guid(IsoDoc::Iec::HtmlConvert.new({})
